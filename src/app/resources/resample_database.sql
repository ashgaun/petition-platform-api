...
# Petition 1
INSERT INTO `petition` (`title`, `description`, `creation_date`, `image_filename`, `owner_id`, `category_id`) VALUES ('Mental Health Awareness in Schools', 'Help us promote and integrate mental health awareness programs into school curricula to support student well-being.', "2023-02-20 09:15:00", 'petition_1.png', 1, 5);
...
INSERT INTO `supporter` (`petition_id`, `support_tier_id`, `user_id`, `message`, `timestamp`) VALUES (6, 13, 2, "Great park to take the family for a walk", '2023-01-20 16:00:16');
